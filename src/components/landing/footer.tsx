    ...
    <footer className="container mt-10 flex flex-wrap justify-between pb-16 pt-10 mt-20">
      <div className="flex basis-full justify-between gap-8 md:basis-auto md:flex-col md:justify-start">
        ...
        <div className="flex items-center gap-5 ml-3">
          <a href="https://github.com/icantcodefyi/diagram/" target="_blank" className="text-muted-foreground hover:text-foreground">
          ...
          <a href="https://x.com/icantcodefyi" target="_blank" className="text-muted-foreground hover:text-foreground">
