        ...
        <div className="relative bg-black h-full w-full">
          ...
          >
            {step.media.type === "image" ? (
              ...
              <video
                src={step.media.src}
                controls={!step.media.autoplay}
                autoPlay={step.media.autoplay}
                loop={step.media.autoplay}
                muted={step.media.autoplay}
                playsInline
            ...
            >
              {steps[currentStep]?.media?.type === "image" ? (
                ...
                <video
                  ...
                  controls={!steps[currentStep]?.media?.autoplay}
                  autoPlay={steps[currentStep]?.media?.autoplay}
                  loop={steps[currentStep]?.media?.autoplay}
                  muted={steps[currentStep]?.media?.autoplay}
                  playsInline
                  className="h-full w-full object-cover"
                />
              )}
